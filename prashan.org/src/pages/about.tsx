...
function AboutPage() {
  return (
    <div className="max-w-screen-lg mx-auto pt-8 md:pt-40 pb-24 md:pb-10 lg:px-0 px-8 md:px-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex-auto">
          ...
          <p className="mb-4">
            I'm extremely proficient in, the required technologies. As I really love Agile and creating value for you, I do not
            mind if you change your mind a lot and iterate ideas - it's all about getting the RIGHT product out. I am a clean code
            enthusiast for this reason and promise to do my best to deliver extensible and maintainable solutions that keep up
