                    ...
                    <div className="description_wrap scrollable">
                      ...
                      <div className="main_content ">
                        <div className="descriptions">
                          <p className="bigger">
                            Just because we can't get out and about like we normally would, doesn’t
                            mean we have to stop taking pictures. There’s still plenty you can do,
                          ...
                          <p>
                            ...
                            more unusual than These Unprecedented Times. Right now everything counts
                            as out of the ordinary. There are a number of remarkable things about
                            these lockdown days that are worth photographing now so we can remember
                          ...
                          {/* END QUOTEBOX */}
                          <p>
                            Pretend everything is new and that you haven’t seen it before, and then
                          ...
                          <p>
                            The trick here is to look slowly, and then look again. Take the time to
                            ...
                            bit. You may never feel the need to leave the house again.
                          </p>
                        </div>
                        {/* END DESCRIPTION */}
                    ...
                    <div className="description_wrap scrollable">
                      ...
                      <div className="main_content ">
                        <div className="descriptions">
                          ...
                          <div className="quotebox">
                            <div className="icon">
                              <img className="svg" src="assets/img/svg/quote.svg" alt="quore" />
                            </div>
                            <p>
                              Most photographers find it hard to see interesting pictures in places
                              in which they are most familiar. A trip somewhere new seems always
