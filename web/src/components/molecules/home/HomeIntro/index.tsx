  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      <div className="avatar flex-none w-[240px] lg:w-[300px] md:mr-16">
        <div
          className={`w-[240px] h-[240px] lg:w-[300px] lg:h-[300px] bg-cover bg-center grayscale-[90%] transition-all duration-200 hover:grayscale-[50%] ${HomeIntroStyles.animated_bubble}`}
          style={{
