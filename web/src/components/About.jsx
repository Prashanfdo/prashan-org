      ...
      <div className="tokyo_tm_about">
        ...
        <div className="description">
          ...
          <div className="description_inner">
            <div className="left">
              <p>
                Hello, I am a creative photographer based in New York and happy to travel all over
                Europe to capture your big day in candid and authentic photos. I will create a
